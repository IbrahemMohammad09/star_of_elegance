...
export default function ContactInformation(){
    return<>
     <MainTitle title={'ContactInformation'} />
     <Navbar/>
     <Title/>
     <div className="flex flex-col md:flex-row gap-10 md:gap-8 pl-12  md:pl-24 mt-6 pr-6  container-contact-information">
        ...
        <div className="flex flex-col w-full ">
         ...
         <p className="font-medium text-base md:text-lg ">
          ...
          <span className="font-semibold text-lg montserrat"> Sat: </span> 09:00 AM To 06:00 PM </p>
          <form className="mt-6">
            ...
            <div className="mt-4">
               ...
               <input type="text" className="w-full md:max-w-[341px] mt-1 block shadow-lg text-2xl bg-white border border-[#8B5715] rounded-lg p-3 h-14 letter-spacing3 "placeholder="657-473-9783"/>
            </div>
            <div className="mt-4">
