...
export default function ProjectDetails() {
  ...
  const addService = async () =>{
      try{
          const response = await axios.post(Api.POST.CREATEPROJECT, 
              {
                  name : name,
              ...
              navigate("/dashboard/project/add/photo/"+selectedId);
      ...
      <div className=" md:flex  gap-14">
          ...
          <div className="pl-28 md:pl-0">
              ...
              <div className="my-14 ">
                  ...
                  <p className="text-[#5F6165] font-normal text-lg dm">Update The project here.</p>
