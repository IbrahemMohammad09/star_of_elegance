    ...
    return<>
        <div className="md:flex  gap-14">
            ...
            <div className="pl-14 md:pl-0">
                ...
                <Link to={"/dashboard/project/view"} className=" flex gap-6 font-semibold text-base text-black max-w-64 rounded shadow-xl  py-16 px-20 hover:border hover:border-[#B47F3E]">
                        <img src={view} alt="icon-view"/>
                        <p className="Poppins font-semibold text-base">View</p>
                    </Link>
                    <Link to={"/dashboard/project/add"} className=" flex gap-6 font-semibold text-base text-black max-w-64 rounded shadow-xl py-16 px-20 hover:border hover:border-[#B47F3E]">
