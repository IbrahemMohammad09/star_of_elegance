      ...
      <div className='flex items-center justify-center'>
        <div className="flex flex-col items-start gap-16 max-w-[600px] px-14 md:pl-14 md:px-36 md:flex-row  md:justify-center  container-CardService mb-32 ">
          ...
          <div className={`flex flex-col items-center sm:items-center md:items-start space-y-0 md:gap-11 text-black md:text-start container-text ${
            ...
            <a href={"/book-your-service/"+service.title}  className="flex gap-3 border border-1px border-[#B47F3D] w-60 py-2 px-10  md:w-72 md:py-4 md:px-12 mt-7 text-[#B47F3D] font-normal text-xl right-4 rounded-lg  hover:bg-[#B47F3D] letter-spacing kanit hover:text-white kanit">Book Now <img src={vector} className='mt-4 md:mt-1' alt='icon'/></a>
          </div>
        </div>
      </div>
     );
