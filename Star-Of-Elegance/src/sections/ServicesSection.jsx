          ...
          <div className="flex flex-1 flex-col items-start w-[100%] gap-32 sm:space-y-10 xl:space-y-16 sm:w-auto sm:mt-0 lg:space-y-0 lg:pl-16 xl:mt-6 xl:p-0 xl:relative xl:-ml-28 xl:gap-10">
            ...
            <div className="xl:mt-12 ">
              <div className="relative flex items-center justify-center w-[100%] h-[150px] rounded-3xl bg-black shadow-xl sm:px-auto sm:w-[100%] md:w-[100%] lg:w-[350px] lg:h-[120px] lg:-rotate-6 xl:w-[488px] xl:h-[181px] xl:-rotate-6">
                ...
                />
                <h3 className="text-4xl font-semibold text-white px-28 pt-10 sm:pt-0 md:px-44 xl:pl-64">
                  Restaurants
                </h3>
              </div>
            </div>
            ...
            <div className="xl:mt-12">
              <div className="relative flex items-center justify-center w-[100%] h-[150px] rounded-3xl bg-black shadow-xl sm:w-[100%] lg:w-[350px] lg:h-[120px] lg:-rotate-6 xl:w-[488px] xl:h-[181px] xl:-rotate-6">
                ...
                />
                <h3 className="text-4xl font-semibold text-white px-28 pt-10 sm:px-32 sm:pt-0 xl:pl-64 md:px-48">
                  Residential
                </h3>
              </div>
            </div>
