...
function ViewMessages() {
  ...
  return (
    <div className="p-6 sm:p-10 bg-gray-100 space-y-10 min-h-screen">
                ...
                {expandedRow === id && (
                  <tr>
                    <td colSpan={6} className="p-6 bg-gray-50">
                      Lorem ipsum dolor sit amet consectetur adipisicing elit.
                      Asperiores cupiditate quidem nisi nihil repellendus.
                      Consectetur quod ipsa, enim cum minus error eius quae,
                      nesciunt repudiandae id illo dolores rerum ducimus nulla
                      et molestiae dolorem voluptas quisquam. Illo dolorum
                      deleniti doloribus enim repellendus neque, illum
                      repudiandae voluptate, rerum architecto asperiores fugiat.
                    </td>
                  </tr>
                )}
              </>
